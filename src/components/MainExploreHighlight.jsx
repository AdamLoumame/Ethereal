	...
	return (
		<div className='relative w-full h-120 max-xs:h-140' style={{ backgroundColor: color?.hex }}>
			<div className='w-fit absolute -top-30 max-md:-top-20 max-sm:-top-12 right-0 z-30 max-xs:hidden' style={{ filter: "drop-shadow(0 25px 50px  var(--dark))" }}>
				<img
					ref={imageStarRef}
					className='star-image h-200 max-md:h-160 max-sm:h-130 opacity-0 scale-50 origin-[70%_50%]'
			...
			<div className={`h-full w-3/5 max-sm:w-4/5 pl-14 py-20 ${color?.isDark ? "text-textDark" : "text-textLight"} max-xs:!h-auto max-xs:absolute max-xs:bottom-0 max-xs:w-full max-xs:p-10`}>
